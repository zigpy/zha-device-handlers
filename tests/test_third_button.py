...
import zhaquirks
from zhaquirks.thirdreality.button import (
...
@pytest.mark.parametrize(
    "quirk",
    (zhaquirks.thirdreality.button.ThirdRealityButton,),  # Replace with actual device quirk class name
)
async def test_third_reality_button(zigpy_device_from_quirk, quirk):
    ...
    private_cluster = device.endpoints[1].in_clusters[ThirdRealityButtonCluster.cluster_id]
