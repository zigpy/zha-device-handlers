...
from zhaquirks.tuya.pj1203_power_meter import (
...
def test_pj1203_device_type():
    ...
    replacement_device_type = TuyaPJ1203PowerMeter.replacement[ENDPOINTS][1][DEVICE_TYPE]
...
async def test_pj1203_voltage_attribute_update(pj1203_device):
    ...
    voltage_update = next(
        (u for u in em_listener.attribute_updates 
