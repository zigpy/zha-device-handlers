"""Tests for the SONOFF BASIC-ZB1GSP quirk."""
...
import zhaquirks
from zhaquirks.sonoff import basic_zb1gsp
...
def sonoff_cluster():
    ...
    cluster = object.__new__(basic_zb1gsp.SonoffCustomCluster)
    return cluster
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_current_max_overload,
            True,
            id="attribute_def",
        ),
        pytest.param(
            basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_current_max_overload.id,
            True,
            id="attribute_id",
        ),
        pytest.param(
            basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_current_max_overload.name,
            True,
            id="attribute_name",
        ),
...
def test_has_attribute_supports_multiple_attribute_key_types(
    ...
    attr_def = basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_current_max_overload
...
async def test_bind_enables_current_and_power_protection(sonoff_cluster):
    ...
    write_attributes.assert_awaited_once_with(
        basic_zb1gsp.SonoffCustomCluster.enable_config
    )
...
async def test_write_current_threshold_enables_current_protection_first(sonoff_cluster):
    ...
    attributes = {
        basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_current_max_overload.name: 16000
    }
    ...
    assert (
        first_call.args[0][
            basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_current_max_overload_enable.id
        ]
        == 0x01
    )
...
async def test_write_power_threshold_enables_power_protection_first(sonoff_cluster):
    ...
    attributes = {
        basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_power_max_overload.name: 2500000
    }
    ...
    assert (
        first_call.args[0][
            basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_power_max_overload_enable.id
        ]
        == 0x01
    )
    assert second_call.args[0] == attributes
...
async def test_write_both_thresholds_enable_both_protections_first(sonoff_cluster):
    ...
    attributes = {
        basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_current_max_overload.id: 16000,
        basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_power_max_overload.id: 2500000,
    }
    ...
    assert super_write.await_args_list[0].args[0] == {
        basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_current_max_overload_enable.id: 0x01,
        basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_power_max_overload_enable.id: 0x01,
    }
...
async def test_write_voltage_threshold_does_not_force_enable_voltage_protection(
    ...
    attributes = {
        basic_zb1gsp.SonoffCustomCluster.AttributeDefs.ac_voltage_max_overload.name: 230000
    }
