...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            2,
            18,
            b"\x18\x49\x0a\x55\x00\x21\x6b\x00",
            "flip",
            {
                "value": 107,
                "flip_degrees": 90,
        ...
        (
            2,
            18,
            b"\x18\x49\x0a\x55\x00\x21\x6c\x00",
            "flip",
            {
                "value": 108,
                "flip_degrees": 90,
        ...
        (
            2,
            18,
            b"\x18\x49\x0a\x55\x00\x21\x65\x00",
            "flip",
            {
                "value": 101,
                "flip_degrees": 90,
        ...
        (
            2,
            18,
            b"\x18\x49\x0a\x55\x00\x21\x41\x00",
            "flip",
            {
                "value": 65,
                "flip_degrees": 90,
        ...
        (
            2,
            18,
            b"\x18\x49\x0a\x55\x00\x21\x80\x00",
            "flip",
            {
                "value": 128,
                "flip_degrees": 180,
        ...
        (
            2,
            18,
            b"\x18\x4b\x0a\x55\x00\x21\x03\x01",
            "slide",
            {"value": 259, "activated_face": 4},
        ),
        (
            3,
            12,
            b"\x18\x50\x0a\x0b\x01\x21\xf4\x01\x55\x00\x39\xff\xff\x8c\x42",
            "rotate_right",
            {"relative_degrees": 70.49999237060547},
        ),
        (
            3,
            12,
            b"\x18\x61\x0a\x49\x01\x20\x05\x0b\x01\x21\xf4\x01\x55\x00\x39\xa5\x70\x75\xc2",
            "rotate_left",
            {"relative_degrees": -61.36000442504883},
        ),
        ...
        (
            2,
            18,
            b"\x18\x36\x0a\x55\x00\x21\x04\x02",
            "knock",
            {"value": 516, "activated_face": 5},
        ),
        # Scene mode:
        (
            2,
            18,
            b"\x18\x69\x0a\x55\x00\x21\x02\x04",
            "scene",
            {"value": 1026, "activated_face": 3},
        ),
