...
import zhaquirks.tuya.ts0601_garden
...
def test_ts0601_garden_signature(assert_signature_matches_quirk):
    """Test TS0601 garden watering remote signature is matched to its quirk."""
    signature = {
