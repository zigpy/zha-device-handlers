...
class RemoteB286OPCN01(XiaomiCustomDevice):
    ...
    device_automation_triggers = {
        ...
        (LONG_PRESS, BUTTON_1): {
            ...
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([1, 69, 7, 0, 0])},
        },
        ...
        (LONG_PRESS, BUTTON_2): {
            COMMAND: COMMAND_STEP_COLOR_TEMP,
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([3, 69, 7, 0, 0])},
        },
...
class RemoteB686OPCN01(XiaomiCustomDevice):
    ...
    device_automation_triggers = {
        ...
        (LONG_PRESS, BUTTON_5): {
            ...
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([1, 15, 0, 0])},
        },
        ...
        (LONG_PRESS, BUTTON_6): {
            COMMAND: COMMAND_MOVE_COLOR_TEMP,
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([3, 15, 0, 0])},
        },
        (ALT_SHORT_PRESS, BUTTON_1): {COMMAND: COMMAND_1_SINGLE},
        (ALT_DOUBLE_PRESS, BUTTON_1): {COMMAND: COMMAND_1_DOUBLE},
        (TRIPLE_PRESS, BUTTON_1): {COMMAND: COMMAND_1_TRIPLE},
