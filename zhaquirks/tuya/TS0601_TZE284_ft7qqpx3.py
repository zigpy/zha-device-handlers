...
class AutoCalibrationCmd(t.enum8):
    """Auto-calibration commands and states."""
...
class ZpsZ1ManufCluster(TuyaMCUCluster):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        """Initialize cached zone and calibration state."""
    ...
    def handle_cluster_specific_commands(
        ...
        """Handle Tuya cluster-specific datapoint reports."""
    ...
    async def write_attributes(
        ...
        **kwargs: Any,
        ...
        """Write attributes by converting them to Tuya datapoints."""
    ...
    async def _disable_calibration_energy_stream(self) -> None:
        try:
            ...
            _LOGGER.debug(
                "[ZPS-Z1] disabling calibration energy stream failed: %s", exc
            )
