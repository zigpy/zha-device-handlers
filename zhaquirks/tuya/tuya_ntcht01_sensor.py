    ...
    signature = {
        ...
        ENDPOINTS: {
            1: {
                PROFILE_ID: 0x0104,
                DEVICE_TYPE: 0x0302,
                INPUT_CLUSTERS: [0x0000, 0x0001, 0x0003, 0x0402, 0x0405, 0x1000, 0xEF00],
    ...
    replacement = {
        ENDPOINTS: {
            1: {
                PROFILE_ID: 0x0104,
                DEVICE_TYPE: 0x0302,
                INPUT_CLUSTERS: [0x0000, 0x0001, 0x0003, 0x0402, 0x0405, 0x1000, NTCHT01TuyaMCU],
                OUTPUT_CLUSTERS: [0x0003, 0x1000, NTCHT01TuyaMCU],
            },
            2: {
                PROFILE_ID: 0x0104,
                DEVICE_TYPE: 0x0302,
                INPUT_CLUSTERS: [Basic.cluster_id, Identify.cluster_id, ExternalProbeTempCluster],
                OUTPUT_CLUSTERS: [],
            },
        }
    }