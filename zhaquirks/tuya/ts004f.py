...
class TuyaSmartRemote004FROK(CustomDevice):
    ...
    device_automation_triggers = {
        ...
        (LONG_PRESS, BUTTON): {
            ...
            ENDPOINT_ID: 1,
            CLUSTER_ID: 768,
            PARAMS: {v: k for v, k in enumerate([1, 200])},
        },
        (ROTATED_SLOW, RIGHT): {
            COMMAND: COMMAND_STEP,
            ENDPOINT_ID: 1,
            CLUSTER_ID: 8,
            PARAMS: {v: k for v, k in enumerate([0, 13, 1])},
        },  # Triggered for both let and right in HA (HA bug).
        (ROTATED_SLOW, LEFT): {
            COMMAND: COMMAND_STEP,
            ENDPOINT_ID: 1,
            CLUSTER_ID: 8,
            PARAMS: {v: k for v, k in enumerate([1, 13, 1])},
        },
        (ROTATED_FAST, RIGHT): {
            COMMAND: COMMAND_STEP,
            CLUSTER_ID: 8,
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([0, 37, 2])},
        },
        (ROTATED_FAST, LEFT): {
            COMMAND: COMMAND_STEP,
            CLUSTER_ID: 8,
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([1, 37, 2])},
        },
...
class TuyaSmartRemote004FDMS(CustomDevice):
    ...
    device_automation_triggers = {
        ...
        (SHORT_PRESS, DIM_UP): {
            ...
            CLUSTER_ID: 8,
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([0, 51, 10])},
        },
        (LONG_PRESS, DIM_UP): {
            COMMAND: COMMAND_MOVE,
            CLUSTER_ID: 8,
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([0, 51])},
        },
        (SHORT_PRESS, DIM_DOWN): {
            COMMAND: COMMAND_STEP,
            CLUSTER_ID: 8,
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([1, 51, 10])},
        },
        (LONG_PRESS, DIM_DOWN): {
            COMMAND: COMMAND_MOVE,
            CLUSTER_ID: 8,
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([1, 51])},
        },
