...
(
    ...
    # same as "normal" but with different multiplier
    .tuya_dp(
        dp_id=16,
        ep_attribute=TuyaThermostat.ep_attribute,
    ...
    # missing: 28 - local temp calibration
    # in herdsman, it's 27
    # Working status - DP 36 (not 3)
    .tuya_dp(
        dp_id=36,
        ep_attribute=TuyaThermostat.ep_attribute,
    ...
    # Measured floor temperature - DP 102
    .tuya_sensor(
        dp_id=102,
    ...
    # Which sensors to use. SensorModeV02 has different values from the SensorModeV01,
    # but they seem to follow the spec for this unit.
    .tuya_enum(
        dp_id=43,
