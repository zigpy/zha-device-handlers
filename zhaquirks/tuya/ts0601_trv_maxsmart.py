...
class MaxsmartManufCluster(TuyaManufClusterAttributes):
    ...
    def _update_attribute(self, attrid, value):
        ...
        if attrid == MAXSMART_BATTERY_ATTR:
            ...
            self.endpoint.device.MaxsmartChildLock_bus.listener_event(
...
class SilvercrestManufCluster(MaxsmartManufCluster):
    """hermostat cluster for LIDL thermostatic valves."""
...
class MaxsmartChildLock(LocalDataCluster, OnOff):
    """On/Off cluster for the child lock function of the electric heating thermostats."""

    def __init__(self, *args, **kwargs):
        """Init."""
        super().__init__(*args, **kwargs)
        self.endpoint.device.MaxsmartChildLock_bus.add_listener(self)
    ...
    async def write_attributes(self, attributes, manufacturer=None):
        ...
        if has_change:
            return await MaxsmartManufClusterSelf.endpoint.tuya_manufacturer.write_attributes(
                {MAXSMART_CHILD_LOCK_ATTR: value}, manufacturer=manufacturer
            )
...
class MaxsmartAwayYear(LocalDataCluster, AnalogOutput):
    ...
    async def write_attributes(self, attributes, manufacturer=None):
        ...
        for attrid, value in attributes.items():
            ...
            await MaxsmartManufClusterSelf.endpoint.tuya_manufacturer.write_attributes(
...
class MaxsmartWindowDetection(LocalDataCluster, BinaryInput):
    """Binary cluster for the window detection function of the electric heating thermostats."""
...
class Maxsmart(TuyaThermostat):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.MaxsmartChildLock_bus = Bus()
...
class Silvercrest(TuyaThermostat):
    ...
    signature = {
        #  endpoint=1 profile=260 device_type=769 device_version=0 input_clusters=[0, 3, 4, 5, 10, 61184]
