...
(
    ...
    .tuya_number(
        ...
        unit=UnitOfTime.SECONDS,
        step=1,
        fallback_name="Vibrating siren duration",
    ...
    .tuya_number(
        ...
        max_value=19,
        step=1,
        fallback_name="Transmission power",
