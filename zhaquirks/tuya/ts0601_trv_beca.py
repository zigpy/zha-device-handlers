...
class BecaWindowDetection(LocalDataCluster, OnOff):
    ...
    def switch_change(self, value):
        ...
        self._update_attribute(self.attridx["on_off"], not value)
    ...
    async def write_attributes(self, attributes, manufacturer=None):
        ...
        if has_change:
            return await BecaManufClusterSelf[
                ...
                {BECA_WINDOW_DETECT_ATTR: not value}, manufacturer=manufacturer
            )
...
class BecaBoostCountdown(LocalDataCluster, AnalogOutput):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._update_attribute(self.attridx["min_present_value"], 0)
        self._update_attribute(self.attridx["resolution"], 1)
        self._update_attribute(self.attridx["application_type"], 12 << 16)
