...
(
    ...
    .change_entity_metadata(
        ...
        new_translation_key="frient_com1",
    )
    .change_entity_metadata(
        endpoint_id=117,
        cluster_id=OnOff.cluster_id,
        ...
        new_translation_key="frient_com2",
    )
    # And the two inputs
    .change_entity_metadata(
        endpoint_id=112,
        ...
        new_translation_key="frient_in1",
    )
    .change_entity_metadata(
        endpoint_id=113,
        cluster_id=BinaryInput.cluster_id,
        ...
        new_translation_key="frient_in2",
    )
    .change_entity_metadata(
        endpoint_id=114,
        cluster_id=BinaryInput.cluster_id,
        ...
        new_translation_key="frient_in3",
    )
    .change_entity_metadata(
        endpoint_id=115,
        cluster_id=BinaryInput.cluster_id,
        ...
        new_translation_key="frient_in4",
    )
    .add_to_registry()
)
