"""Sonoff MINI-ZB1GS - Zigbee On/Off Outlet."""
...
class SonoffCluster(CustomCluster):
    ...
    class ServerCommandDefs(CustomCluster.ServerCommandDefs):
        ...
        start_ble_pairing: Final = ZCLCommandDef(
            id=0x0C,
            schema={
...
(
    ...
    .removes(0x0702)
    .command_button(
        SonoffCluster.ServerCommandDefs.start_ble_pairing.name,
        ...
        translation_key="start_ble_pairing",
        fallback_name="Start Ble Pairing",
    )
    .enum(
    ...
    .sensor(
        attribute_name=SonoffCluster.AttributeDefs.remote_temperature.name,
