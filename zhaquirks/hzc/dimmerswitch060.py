...
class OutEdge(t.enum8):
    """OutEdge Class for HzcLevelControl."""
...
class ModeType(list, metaclass=t.KwargTypeMeta):
    """ModeType Class for WorkModeCluster,WorkProgramCluster."""
