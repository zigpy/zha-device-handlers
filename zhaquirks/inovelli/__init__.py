    ...
    attributes.update(
        {
            ...
            0x0016: ("switch_type", t.uint8_t, True),
            0x0019: ("increased_non_neutral_output", t.Bool, True),
            0x001A: ("leading_or_trailing_edge", t.uint8_t, True),
            0x0032: ("button_delay", t.uint8_t, True),
            0x0033: ("device_bind_number", t.uint8_t, True),
            0x0035: ("double_tap_up_enabled", t.Bool, True),
            0x0036: ("double_tap_down_enabled", t.Bool, True),
...
class InovelliVZM32SNMMWaveCluster(CustomCluster):
    ...
    name = "InovelliVZM32SNMMWaveCluster"

    attributes = {
        0x0065: ("mmwave_height_min", t.int16s, True),
        0x0066: ("mmwave_height_max", t.int16s, True),
        0x0067: ("mmwave_width_min", t.int16s, True),
        0x0068: ("mmwave_width_max", t.int16s, True),
        0x0069: ("mmwave_depth_min", t.int16s, True),
        0x006A: ("mmwave_depth_max", t.int16s, True),
        0x006B: ("mmwave_target_info_report", t.uint8_t, True),
        0x006C: ("mmwave_stay_life", t.uint32_t, True),
        0x0070: ("mmwave_detect_sensitivity", t.uint8_t, True),
        0x0071: ("mmwave_detect_trigger", t.uint8_t, True),
        0x0072: ("mmwave_hold_time", t.uint32_t, True),
        0x0073: ("mmwave_version", t.uint32_t, True),
    }
