...
(
    ...
    .write_attr_button(
        ...
        endpoint_id=1,
        translation_key="reset_summation_delivered_1",
    ...
    .write_attr_button(
        ...
        cluster_id=ThirdRealityPlugCluster.cluster_id,
        endpoint_id=2,
        translation_key="reset_summation_delivered_2",
    ...
    .number(
        ...
        unit=UnitOfTime.SECONDS,
        device_class=NumberDeviceClass.DURATION,
        translation_key="off_to_on_delay_1",
    ...
    .number(
        ...
        unit=UnitOfTime.SECONDS,
        device_class=NumberDeviceClass.DURATION,
        translation_key="off_to_on_delay_2",
