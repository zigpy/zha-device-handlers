...
from zhaquirks.schneiderelectric.clusters import SESpecificCluster
...
class CHxAXSwitch1(CustomDevice):
    """CH2AX/SWITCH/1 and CH10AX/SWITCH/1 from Schneider Electric."""
    ...
    signature = {
        MODELS_INFO: [
            (SE_MANUF_NAME, "CH2AX/SWITCH/1"),
            (SE_MANUF_NAME, "CH10AX/SWITCH/1"),
        ],
        ENDPOINTS: {
            1: {
                PROFILE_ID: zha.PROFILE_ID,
