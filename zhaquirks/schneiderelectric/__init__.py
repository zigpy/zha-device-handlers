...
class SEBasicCluster(SEManufCluster, Basic):
    ...
    attributes.update(
        {
            0xE001: ("unknown_attribute_57345", t.CharacterString)
        },  # attribute_name:"57345" # ex: "002.004.016 R
        {
            0xE002: ("unknown_attribute_57346", t.CharacterString)
        },  # attribute_name:"57346" # ex: "001.000.000"
        {
            0xE004: ("unknown_attribute_57348", t.CharacterString)
        },  # attribute_name:"57348"  # ex: "213249FEFF5ECFD"
        {0xE007: ("unknown_attribute_57351", t.enum16)},  # attribute_name:"57351"
        {
            0xE008: ("unknown_attribute_57352", t.CharacterString)
        },  # attribute_name:"57352" # ex: "Wiser Light"
        {
            0xE009: ("unknown_attribute_57353", t.CharacterString)
        },  # attribute_name:"57353" # ex: "NHPB/SHUTTER/1"
        {
            0xE00A: ("unknown_attribute_57354", t.CharacterString)
        },  # attribute_name:"57354" # ex: "Wiser Home"
        {
            0xE00B: ("unknown_attribute_57355", t.CharacterString)
