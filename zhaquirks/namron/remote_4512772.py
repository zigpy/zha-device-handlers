...
(
    ...
    .prevent_default_entity_creation(
        endpoint_id=2, cluster_id=PowerConfiguration.cluster_id
    )
    .prevent_default_entity_creation(
        endpoint_id=2, cluster_id=Ota.cluster_id, cluster_type=ClusterType.Client
    )
    .prevent_default_entity_creation(
        endpoint_id=3, cluster_id=PowerConfiguration.cluster_id
    )
    .prevent_default_entity_creation(
        endpoint_id=3, cluster_id=Ota.cluster_id, cluster_type=ClusterType.Client
    )
    .prevent_default_entity_creation(
        endpoint_id=4, cluster_id=PowerConfiguration.cluster_id
    )
    .prevent_default_entity_creation(
        endpoint_id=4, cluster_id=Ota.cluster_id, cluster_type=ClusterType.Client
    )
    .add_to_registry()
)
