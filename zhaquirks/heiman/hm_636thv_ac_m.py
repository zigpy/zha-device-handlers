"""Heiman HM-636THV-AC-M smoke and CO sensor."""
...
class SensorExpiresEnum(t.enum8):
    """Co sensor Expiration state."""
...
class SensorAlarmLevelEnum(t.enum8):
    """Co sensor alarm level."""
...
class CustomHeimanCluster(CustomCluster):
    ...
    class AttributeDefs(BaseAttributeDefs):
        ...
        sensor_life_state = ZCLAttributeDef(
            id=0x0006,
            type=SensorExpiresEnum,
            manufacturer_code=0x120B,
        )
        ...
        co_alarm_level = ZCLAttributeDef(
            id=0x0013,
            type=SensorAlarmLevelEnum,
            manufacturer_code=0x120B,
        )
...
(
    QuirkBuilder()
    .applies_to("HEIMAN", "HM-636THV-AC-M")
    .friendly_name(manufacturer="HEIMAN", model="HM-636THV-AC-M")
    ...
    .enum(
        CustomHeimanCluster.AttributeDefs.co_alarm_level.name,
