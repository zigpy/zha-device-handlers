...
class AuroraDimmerBatteryPowered(CustomDevice):
    ...
    device_automation_triggers = {
        (DIM_UP, RIGHT): {
            ...
            CLUSTER_ID: 8,
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([0, 26, 3])},
        },
        (DIM_DOWN, RIGHT): {
            COMMAND: COMMAND_STEP,
            CLUSTER_ID: 8,
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([1, 26, 3])},
        },
        (COLOR_UP, RIGHT): {
            COMMAND: COMMAND_STEP_COLOR_TEMP,
            CLUSTER_ID: 768,
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([3, 47, 3, 153, 454])},
        },
        (COLOR_DOWN, RIGHT): {
            COMMAND: COMMAND_STEP_COLOR_TEMP,
            CLUSTER_ID: 768,
            ENDPOINT_ID: 1,
            PARAMS: {v: k for v, k in enumerate([1, 47, 3, 153, 454])},
        },
        (DIM_UP, LEFT): {
            COMMAND: COMMAND_STEP,
            CLUSTER_ID: 8,
